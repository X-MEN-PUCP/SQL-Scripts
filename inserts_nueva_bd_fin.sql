...
INSERT INTO `universidad`.`cita` 
(`id_medico`, `id_especialidad`, `id_turno`, `id_consultorio`, `hora_inicio`, `hora_fin`, `fecha_cita`, `estado_cita`, `usuario_creación`, `fecha_creacion`) VALUES
(3, 1, 1, 4, '11:00:00', '11:30:00', '2025-07-01', 1, 1, NOW()),
(3, 2, 1, 4, '11:30:00', '12:00:00', '2025-07-01', 1, 1, NOW()),
(5, 5, 2, 5, '16:00:00', '16:30:00', '2025-07-01', 1, 1, NOW()),
(5, 6, 2, 5, '17:00:00', '17:30:00', '2025-07-01', 1, 1, NOW()),
(4, 4, 3, 2, '20:30:00', '21:00:00', '2025-07-01', 1, 1, NOW()),
(4, 3, 3, 2, '21:30:00', '22:00:00', '2025-07-01', 1, 1, NOW()),
(5, 5, 1, 3, '08:00:00', '08:30:00', '2025-07-01', 1, 1, NOW()),

(3, 1, 1, 4, '11:00:00', '11:30:00', '2025-07-02', 1, 1, NOW()),
(3, 2, 1, 4, '11:30:00', '12:00:00', '2025-07-02', 1, 1, NOW()),
(5, 5, 2, 5, '16:00:00', '16:30:00', '2025-07-02', 1, 1, NOW()),
(5, 6, 2, 5, '17:00:00', '17:30:00', '2025-07-02', 1, 1, NOW()),
(4, 4, 3, 2, '20:30:00', '21:00:00', '2025-07-02', 1, 1, NOW()),
(4, 3, 3, 2, '21:30:00', '22:00:00', '2025-07-02', 1, 1, NOW()),
(5, 5, 1, 3, '08:00:00', '08:30:00', '2025-07-02', 1, 1, NOW()),

(3, 1, 1, 4, '11:00:00', '11:30:00', '2025-07-03', 1, 1, NOW()),
(3, 2, 1, 4, '11:30:00', '12:00:00', '2025-07-03', 1, 1, NOW()),
(5, 5, 2, 5, '16:00:00', '16:30:00', '2025-07-03', 1, 1, NOW()),
(5, 6, 2, 5, '17:00:00', '17:30:00', '2025-07-03', 1, 1, NOW()),
(4, 4, 3, 2, '20:30:00', '21:00:00', '2025-07-03', 1, 1, NOW()),
(4, 3, 3, 2, '21:30:00', '22:00:00', '2025-07-03', 1, 1, NOW()),
(5, 5, 1, 3, '08:00:00', '08:30:00', '2025-07-03', 1, 1, NOW()),

(3, 1, 1, 4, '11:00:00', '11:30:00', '2025-07-04', 1, 1, NOW()),
(3, 2, 1, 4, '11:30:00', '12:00:00', '2025-07-04', 1, 1, NOW()),
(5, 5, 2, 5, '16:00:00', '16:30:00', '2025-07-04', 1, 1, NOW()),
(5, 6, 2, 5, '17:00:00', '17:30:00', '2025-07-04', 1, 1, NOW()),
(4, 4, 3, 2, '20:30:00', '21:00:00', '2025-07-04', 1, 1, NOW()),
(4, 3, 3, 2, '21:30:00', '22:00:00', '2025-07-04', 1, 1, NOW()),
(5, 5, 1, 3, '08:00:00', '08:30:00', '2025-07-04', 1, 1, NOW());
